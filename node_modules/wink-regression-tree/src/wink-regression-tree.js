  ...
  */
  var growTree = function ( cc, splitData, colUsed4Split, node, depth ) {
    ...
    for ( uniqVal in splitData ) { // eslint-disable-line guard-for-in
      ...
      console.log('colUsed4Split', colUsed4Split);
      console.log('xc2cMap', JSON.stringify(xc2cMap));
      console.log('columnsDefn', JSON.stringify(columnsDefn));
      console.log('uniqVal', JSON.stringify(uniqVal));
      console.log('otherValue', '$$other_values');
